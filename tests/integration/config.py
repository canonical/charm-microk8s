...
MK8S_CHARM_CHANNEL = os.getenv("MK8S_CHARM_CHANNEL", "1.28")
...
MK8S_METALLB_CHANNEL = os.getenv("MK8S_METALLB_CHANNEL", "1.28/stable")
...
#   - 'edge'                    <-- install charm from 'edge' channel
MK8S_HELLO_KUBECON_CHANNEL = os.getenv("MK8S_HELLO_KUBECON_CHANNEL", "stable")
...
#   - 'edge'                    <-- install charm from 'edge' channel
MK8S_COREDNS_CHANNEL = os.getenv("MK8S_COREDNS_CHANNEL", "1.28/stable")
